...
lazy val root = (project in file("."))
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "com.typesafe.akka" %% "akka-cluster" % "2.10.1",
      "com.typesafe.akka" %% "akka-cluster-sharding-typed" % "2.10.1",
      "com.typesafe.akka" %% "akka-http" % "10.7.0",
      "com.typesafe.akka" %% "akka-serialization-jackson" % "2.10.1",
      "com.typesafe.akka" %% "akka-persistence" % "2.10.1",
      "com.typesafe.akka" %% "akka-persistence-typed" % "2.10.1",
      "com.typesafe.akka" %% "akka-persistence-cassandra" % "1.3.0",
      "com.typesafe.akka" %% "akka-persistence-query" % "2.10.1",
